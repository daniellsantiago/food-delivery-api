...
public interface CuisineControllerOpenApi {
    ...
    CuisineDTO findById(@ApiParam(value = "Cuisine ID", example = "1", required = true)
                                        Long id);
    ...
    CuisineDTO save(@ApiParam(name = "body", value = "Represents a new Cuisine", required = true)
    ...
    CuisineDTO update(@ApiParam(name = "body", value = "Represents a new Cuisine", required = true)
                                      CuisineInput cuisineInput,
    ...
    void delete(@ApiParam(value = "Cuisine ID", required = true)
                                Long id);
}
