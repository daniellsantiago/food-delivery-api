...
public interface StateControllerOpenApi {
    ...
    StateDTO findById(@ApiParam(value = "State ID", example = "1", required = true)
                                      Long id);
    ...
    StateDTO save(@ApiParam(name = "body", value = "Represents a new State", required = true)
    ...
    StateDTO update(@ApiParam(value = "State ID", example = "1", required = true)
                                    Long id,
    ...
    void delete(@ApiParam(value = "State ID", example = "1", required = true)
                                Long id);
}
