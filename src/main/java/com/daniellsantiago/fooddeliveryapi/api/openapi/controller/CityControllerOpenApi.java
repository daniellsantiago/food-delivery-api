...
public interface CityControllerOpenApi {
    ...
    ResponseEntity<CityDTO> findById(@ApiParam(value = "City ID", example = "1")
                                     Long id);
    ...
    ResponseEntity<CityDTO> save(@ApiParam(name = "body", value = "Represents a new City")
                                 CityInput cityInput);
    ...
    ResponseEntity<CityDTO> update(@ApiParam(name = "body", value = "Represents a new City")
                                   CityInput cityInput,
    ...
    ResponseEntity<Void> delete(@ApiParam(value = "City ID", example = "1")
                                Long id);
}
